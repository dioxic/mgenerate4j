...
@SupportedAnnotationTypes("com.dioxic.mgenerate.annotation.BuilderProperty")
@SupportedSourceVersion(SourceVersion.RELEASE_8)
public class BuilderProcessorOld extends AbstractProcessor {
    ...
    private void writeBuilderFile(String className, Map<String, String> setterMap) throws IOException {
        ...
        TypeSpec builder = TypeSpec.classBuilder(builderSimpleClassName)
    ...
    private void writeBuilderFileOld(String className, Map<String, String> setterMap) throws IOException {
