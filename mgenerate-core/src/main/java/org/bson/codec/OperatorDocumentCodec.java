...
public class OperatorDocumentCodec implements CollectibleCodec<Document> {
     ...
     */
    public OperatorDocumentCodec(final CodecRegistry registry) {
     ...
     */
    public OperatorDocumentCodec(final CodecRegistry registry, final BsonTypeClassMap bsonTypeClassMap) {
     ...
     */
    public OperatorDocumentCodec(final CodecRegistry registry, final BsonTypeClassMap bsonTypeClassMap, final Transformer valueTransformer) {
        ...
        this.valueTransformer = valueTransformer != null ? valueTransformer : new OperatorTransformer();
    }
