...
public final class FlsUtil {
     ...
     */
    private static double moveCost(final Point a, final Point b,
     ...
     */
    private static void activate(final Point a, final Point b,
                          final Point c, final Point d) {
        a.setActive(true);
        b.setActive(true);
        c.setActive(true);
    ...
    private static double findMove(final int current, final Point currentPoint,
                            final Point[] points, final int numPoints) {
     ...
     */
    public static void optimise(final Point[] points) {
